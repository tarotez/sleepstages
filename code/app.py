...
class RemApplication(QMainWindow):
    ...
    def initUI(self):
        ...
        checkConnectionButton.move(85, 10)
        ...
        self.classifier_combobox.move(340, 10)
        ...
        self.nameLabel_ch2_override_label.move(450, 10)
        ...
        self.overrideOrNotButton.move(530, 10)
        ...
        self.nameLabel_ch2_mode_label.move(600, 10)
        ...
        self.ch2_mode_combobox.move(670, 13)
        ...
        self.nameLabel_ch2_thresh.move(840, 15)
